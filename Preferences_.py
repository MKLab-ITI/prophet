...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.gridLayout_7.addWidget(self.checkBoxCheckForUpdatesAtStartupOption, 0, 2, 1, 1)
        self.line_4 = QtGui.QFrame(self.tabGeneral)
        self.line_4.setFrameShape(QtGui.QFrame.HLine)
        self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_4.setObjectName(_fromUtf8("line_4"))
        self.gridLayout_7.addWidget(self.line_4, 1, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.spinBoxEMInstancesLimit, 2, 1, 1, 2, QtCore.Qt.AlignRight)
        ...
        self.gridLayout_7.addWidget(self.lblSameAsOption, 4, 0, 1, 1)
        ...
        self.comboBoxSameAsOption.addItem(_fromUtf8(""))
        self.comboBoxSameAsOption.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.comboBoxSameAsOption, 4, 1, 1, 2, QtCore.Qt.AlignRight)
        self.line_2 = QtGui.QFrame(self.tabGeneral)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.gridLayout_7.addWidget(self.line_2, 5, 0, 1, 3)
        self.lblLabelOption = QtGui.QLabel(self.tabGeneral)
        self.lblLabelOption.setObjectName(_fromUtf8("lblLabelOption"))
        self.gridLayout_7.addWidget(self.lblLabelOption, 6, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.checkBoxLabelOption, 6, 2, 1, 1)
        self.line_3 = QtGui.QFrame(self.tabGeneral)
        self.line_3.setFrameShape(QtGui.QFrame.HLine)
        self.line_3.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_3.setObjectName(_fromUtf8("line_3"))
        self.gridLayout_7.addWidget(self.line_3, 7, 0, 1, 3)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_7.addItem(spacerItem, 8, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.btnSaveChangesInGeneralTab, 9, 1, 1, 2, QtCore.Qt.AlignRight)
        ...
        self.lblMyModels = QtGui.QLabel(self.tabMyModel)
        self.lblMyModels.setObjectName(_fromUtf8("lblMyModels"))
        self.gridLayout_6.addWidget(self.lblMyModels, 0, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.tableWidgetMyModels, 1, 0, 1, 4)
        ...
        self.gridLayout_6.addWidget(self.btnAddMyModel, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.btnDeleteMyModel, 2, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.btnLoadMyModel, 2, 3, 1, 1)
        icon1 = QtGui.QIcon()
        ...
        self.lblKnownEndpoints = QtGui.QLabel(self.tabEndpoints)
        self.lblKnownEndpoints.setObjectName(_fromUtf8("lblKnownEndpoints"))
        self.gridLayout_2.addWidget(self.lblKnownEndpoints, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tableWidgetKnownEndpoints, 1, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.btnAddEndpoint, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btnDeleteEndpoint, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btnSelectEndpoint, 2, 3, 1, 1)
        icon2 = QtGui.QIcon()
        ...
        self.lblKnownNamespaces = QtGui.QLabel(self.tabNamespaces)
        self.lblKnownNamespaces.setObjectName(_fromUtf8("lblKnownNamespaces"))
        self.gridLayout_4.addWidget(self.lblKnownNamespaces, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.btnAddNamespace, 2, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.btnDeleteNamespace, 2, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.btnRestoreDefaultNamespaces, 2, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.tableWidgetKnownNamespaces, 1, 0, 1, 4)
        icon3 = QtGui.QIcon()
        ...
        self.lblKnownNamespaces_2 = QtGui.QLabel(self.tabMapping)
        self.lblKnownNamespaces_2.setObjectName(_fromUtf8("lblKnownNamespaces_2"))
        self.gridLayout_5.addWidget(self.lblKnownNamespaces_2, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.tableWidgetKnownMappings, 1, 0, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.btnDeleteMapping, 2, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btnDeleteAllMappings, 2, 2, 1, 1)
        icon4 = QtGui.QIcon()
        ...
        self.lblLogEntries = QtGui.QLabel(self.tabLog)
        self.lblLogEntries.setObjectName(_fromUtf8("lblLogEntries"))
        self.gridLayout_3.addWidget(self.lblLogEntries, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnClearLog, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tableWidgetLogEntries, 1, 0, 1, 2)
        icon5 = QtGui.QIcon()
        ...
        self.lblDatabaseStats = QtGui.QLabel(self.tabDatabase)
        self.lblDatabaseStats.setObjectName(_fromUtf8("lblDatabaseStats"))
        self.gridLayout_8.addWidget(self.lblDatabaseStats, 0, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.tableWidgetDatabaseStats, 1, 0, 1, 5)
        ...
        self.gridLayout_8.addWidget(self.btnExportDatabase, 3, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.btnImportDatabase, 3, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.btnResetToDefaultDatabase, 3, 4, 1, 1)
        icon6 = QtGui.QIcon()
        ...
        self.tabWidgetPreferences.setCurrentIndex(0)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.lblEMInstancesLimit.setText(_translate("Preferences", "Limit query results from External Model to:", None))
        ...
        self.lblMyModels.setToolTip(_translate("Preferences", "Initial (source) models are those that are available to be populated by External Models", None))
        self.lblMyModels.setText(_translate("Preferences", "My models:", None))
        ...
        item.setText(_translate("Preferences", "URL", None))
        ...
        self.lblKnownEndpoints.setToolTip(_translate("Preferences", "All stored endpoints. The user may add a new endpoint, delete or select an existing one", None))
        self.lblKnownEndpoints.setText(_translate("Preferences", "Known endpoints:", None))
        ...
        item.setText(_translate("Preferences", "Endpoint URL", None))
        ...
        self.lblKnownNamespaces.setToolTip(_translate("Preferences", "All stored namespaces. The user may add a new namespace, delete or select an existing one", None))
        self.lblKnownNamespaces.setText(_translate("Preferences", "Known namespaces:", None))
        ...
        self.lblKnownNamespaces_2.setToolTip(_translate("Preferences", "All user-defined mappings between models\' properties. The user may add new mappings or may delete existing ones", None))
        self.lblKnownNamespaces_2.setText(_translate("Preferences", "Known mappings:", None))
        ...
        self.lblLogEntries.setToolTip(_translate("Preferences", "Log entries recorder through the use of PROPheT", None))
        self.lblLogEntries.setText(_translate("Preferences", "Log entries:", None))
        ...
        self.lblDatabaseStats.setText(_translate("Preferences", "Database stats:", None))
